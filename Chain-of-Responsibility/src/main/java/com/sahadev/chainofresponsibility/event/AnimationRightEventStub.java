 ...
 */
public class AnimationRightEventStub extends EventStub<View> {
     ...
     */
    public AnimationRightEventStub(IEvent mEventStub, View viewStub) {
    ...
    protected boolean onEventImpl(@NonNull View obj) {
        if (result) {
            ObjectAnimator anim = ObjectAnimator.ofFloat(obj, "translationX", 1200f);
